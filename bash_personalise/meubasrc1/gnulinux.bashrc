...
${six_spc}${six_spc}${b_yellow}((__-^^-,-^^-__))            ${six_spc}${six_spc}${b_blue}#${b_write}101${b_yellow}\l/${b_write}010${b_blue}#
 ${six_spc}${six_spc}${b_yellow}*---*******---*            ${six_spc}${six_spc}${b_blue}#${b_write}101010101010${b_blue}#
  ${six_spc}${six_spc}${b_yellow}*--|${b_cyan}o   o${b_yellow}|--*            ${six_spc}${six_spc}${b_blue}#${b_write}01010101010101${b_blue}#
