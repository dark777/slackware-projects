...
1-8ª) Passo - Criando senha de primeiro acesso:

bash-4.4$ mysqladmin -u root password NOVASENHA
...
2-6ª.1ª) Passo - Outras formas de alterar a senha do Mysql:
...
sqlname="backup_$data.sql"
logname="mysql_$data.log"
